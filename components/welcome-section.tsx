      ...
      <div className="container mx-auto px-4 md:px-6">
        ...
        <div ref={textRef} className="opacity-0 mt-8 max-w-3xl mx-auto space-y-4 text-muted-foreground">
          <p>
            ...
            Systems & Networks (ICISN 2025) on 22-23 March 2025. The conference will focus on the Intelligent Systems
          ...
          <p>
            We would like to invite you to contribute your unpublished research work and participate in ICISN 2025. The
            two days international technical forum will allow you to interact with numbers of National and International
            delegates. The ICISN 2025 offers a rich program, including keynote speeches, regular presentations,
